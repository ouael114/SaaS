            ...
            <div class="forny-form">
              ...
              <div class="alert alert-danger" v-if="err"> 
                ...
                <div class="mt-10">
                  ...
                  <a @click.prevent="GoToRegister" class="ibtn"
                    >Register here</a
                  >
                </div>
              </form>
            ...
            <div class="text-center" style="width: 300px">
              ...
              >
                ...
                <path
                  ...
                  transform="translate(-368.986 -99.915)"
                />
                <path
                  class="e"
                  d="M224.814,176.9l55.167,101.068,55.167,101.064H114.48l55.167-101.064Z"
                  transform="translate(-72.403 -115.032)"
                />
                <g class="f" transform="translate(119.12 161.253)">
                  <path
                    ...
                    transform="translate(-521.084 -533.871)"
                  />
                </g>
                <path
                  class="h"
                  ...
                  transform="translate(-403.743 -374.739)"
                />
                <circle
                  class="i"
                  cx="2.393"
                ...
                <ellipse
                  ...
                  rx="3.587"
                  ry="2.393"
                  transform="translate(143.033 190.412) rotate(-71.4)"
                />
                <circle
                  class="h"
                  cx="3.587"
                ...
                <g class="k" transform="translate(123.66 19.958)">
                  ...
                  <path
                    ...
                    transform="translate(-535.858 -142.992)"
                  />
                  <circle
                    class="i"
                    cx="2.393"
                ...
                <path
                  ...
                  transform="translate(-371.362 -149.455)"
                />
                ...
                <path
                  ...
                  transform="translate(-256.907 -118.827)"
                />
                <path
                  class="o"
                  ...
                  transform="translate(-588.576 -313.934)"
                />
                <path
                  class="o"
                  ...
                  transform="translate(-223.387 -404.369)"
                />
                <path
                  class="o"
                  ...
                  transform="translate(-188.634 -193.566)"
                />
                <path
                  class="o"
                  ...
                  transform="translate(-581.933 -86.571)"
                />
                <g class="k" transform="translate(37.857 93.627)">
                  ...
                  <rect
                    ...
                    width="1.103"
                    height="6.248"
                    transform="translate(6.248 2.573) rotate(90)"
                  />
                </g>
              ...
              <div class="mt-10">
                <h4 class="mb-4">Welcome to Next Consult.</h4>
                <p>
                  Lorem ipsum dolor sit amet, consectetuer adipiscing elit, sed
                  diam nonumm. Lorem ipsum dolor sit amet, consectetuer
                  adipiscing elit,
                </p>
              </div>
            </div>
